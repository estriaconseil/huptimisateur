    ...
    <form className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Recherche avec Google (Canada). Complétez les champs si besoin après sélection.
          </CardDescription>
        </CardHeader>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        >
          {formState.isSubmitting ? "Enregistrement…" : "Créer la job"}
        </Button>
        <Button
          type="button"
          variant="secondary"
        ...
        >
          Créer et suggérer une planification
        </Button>
      </div>
    </form>
  );
